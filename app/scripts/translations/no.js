...
no.data = {
  ...
  ADD_Radio_5_Path:       'Velg HD derivation path',
  ...
  PARITY_Old:                   "Transaksjons-nonce er for lav. Prøv å øke nonce (+1) gradvis.",
  ...
  PARITY_LimitReached:          "Det er for mange transaksjoner i køen. Din transaksjon ble av denne grunn droppet. Prøv å øke avgiften.",
  PARITY_InsufficientGasPrice:  "Transaksjonsavgiften er for lav. Den tilfredsstiller ikke nodens minimumsavgift (minimal: {}, got: {}). Prøv å øke avgiften.",
  PARITY_InsufficientBalance:   "Utilstrekkelige midler. Kontoen som du prøver å sende transaksjoner fra har ikke inneholder ikke tilstrekkelige midler. Required {} and got: {}.",
  PARITY_GasLimitExceeded:      "Transaksjonskostnaden overskrider den nåværende gas-grensen. Limit: {}, got: {}. Prøv å redusere levert gas.",
  PARITY_InvalidGasLimit:       "Levert gas er over grensen.",
  ...
  HELP_13_Title:          '13) Hva betyr "Utilstrekkelige midler. Kontoen som du prøver å sende transaksjoner fra har ikke inneholder ikke tilstrekkelige midler. Påkrevd XXXXXXXXXXXXXXXXXXX og mottatt: XXXXXXXXXXXXXXXX." ?',
  HELP_13_Desc_1:         'Dette betyr at du ikke har nok Ether på kontoen din til å dekke gas-kostnaden. Hver transaksjon (inkludert token- og kontrakt-transaksjoner) krever gas, og denne gas-en betales med Ether. Tallet som vises er beløpet som kreves for å dekke transaksjonskostnaden i Wei (1 Ether = 10^18 Wei). Ta dette tallet, del med `1000000000000000000`, og trekk fra beløpet i Ether som du prøvde å sende (hvis du prøvde å sende Ether). Dette vil gi deg mengden Ether som du må sende til denne kontoen for å utføre transaksjonen.',
